...
{
    public class TallGrassCardController : CardController
    {
        public TallGrassCardController(Card card, TurnTakerController turnTakerController)
        ...
        {
            // When this card is destroyed, play a Short Grass from the environment trash.
        ...
        private IEnumerator OnDestroyResponse(DestroyCardAction dca)
        {
            ...
            var coroutine = this.GameController.SelectCardsFromLocationAndMoveThem(
                ...
                1,
                1,
                new LinqCardCriteria((Card c) => c.Identifier == "ShortGrass" && c.IsInTrash),
